...
quizesCookie = Cookies.getJSON('com.neo4j.graphacademy.neo4jadministration.quizes');
if (quizesCookie) {
...
function getQuizStatus() {
  return getQuizStatusRemote().then( function( value ) { 
    ...
    Cookies.set('com.neo4j.graphacademy.neo4jadministration.quizes', JSON.stringify(quizesStatusL) );
